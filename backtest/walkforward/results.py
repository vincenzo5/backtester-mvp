    ...
    def calculate_aggregates(self):
        ...
        for window in self.window_results:
            if window.out_sample_metrics:
                ...
                total_oos_return += window.out_sample_metrics.total_return_pct
                valid_windows += 1
        
        self.total_oos_net_profit = total_oos_profit
        self.avg_oos_return_pct = total_oos_return / valid_windows if valid_windows > 0 else 0.0
        
        # Total OOS return is sum of all OOS returns
        self.total_oos_return_pct = total_oos_return if valid_windows > 0 else 0.0
